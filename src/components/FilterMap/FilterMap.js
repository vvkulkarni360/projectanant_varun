...
//                                 data-target={`dropdown${option.id}`}
...
const FilterMap = () => {
    ...
    const handleCheckboxChange = (event) => {
        ...
        // Set dropdown visibility based on checkbox status
                ...
                <form id="selectors">
                    {FilterMapdata.map(option => (
                        <div key={option.id}>
                            ...
                            {dropdownVisible[option.value] && (
                                <div className="dropdown">
                                    <select>
                                        <option>Select {option.label}</option>
                                        {DropdownItems[option.value].map((item, index) => (
